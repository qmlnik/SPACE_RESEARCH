<template>
    <ArticleHeader
        ...
        :images="[
            {
                mobile: explorer_1_mobile,
                tablet: explorer_1_tablet,
                desktop: explorer_1_desktop
            },
            {
                mobile: vanguard1_mobile,
                tablet: vanguard1_tablet,
                desktop: vanguard1_desktop
            },
            {
                mobile: sputnik_3_mobile,
                tablet: sputnik_3_tablet,
                desktop: sputnik_3_desktop
            }
        ]"
    />
    <div class="px-3 pb-3">
        ...
        <div class="mb-3" style="float: left">
            <figure class="article-image-container article-image-left figure">
                <img
                    ...
                    alt="Vanguard-1"
                />
                <figcaption class="figure-caption text-center">Vanguard-1</figcaption>
            </figure>
            <p>
                ...
                A többi  műholdhoz képest viszont ő volt az első, ami napelemeket használt.
                Az eszköz céljai a 3 fázisú Vanguard rakéta tesztelése és a környezeti hatások vizsgálata
                Föld körüli pályán.
            </p>
            <p>
                ...
                üzemeltették, ezek 1964-ig működtek, azóta már csak vizuálisan lehet nyomon követni.
            </p>
        </div>
        ...
        <div class="mb-3" style="float: left">
            ...
            <p>
                <span class="fw-bold">1958 május 15-én a szovjetek fellövik a Szputnyik 3-at a
                bajkonuri űrrepülőtérről.</span>
                A Nemzetközi geofizikai év (1957 júl. 1. - 1958 dec. 31.) alatt lőtték fel, hogy általánosságban
        ...
        <div class="mb-3" style="float: left">
            <figure class="article-image-container article-image-left figure">
                ...
                />
                <figcaption class="figure-caption text-center">Szputnyik-3 előkészítése</figcaption>
            </figure>
            <p>
                A Szputnyik-3 a tudományos mérések feladatát kapta, egy önműködő laboratórium volt lényegében.
                Többek között vizsgálta a légkör felsőbb rétegeinek nyomását és összetételét,
                töltött részecskék koncentrációját
...
<script>
import sputnik_3_mobile from "~/assets/images/article/1958/header/mobile/sputnik_3_mobile.webp";
import sputnik_3_tablet from "~/assets/images/article/1958/header/tablet/sputnik_3_tablet.webp";
import sputnik_3_desktop from "~/assets/images/article/1958/header/desktop/sputnik_3_desktop.webp";

import explorer_1_mobile from "~/assets/images/article/1958/header/mobile/explorer_1_mobile.webp";
import explorer_1_tablet from "~/assets/images/article/1958/header/tablet/explorer_1_tablet.webp";
import explorer_1_desktop from "~/assets/images/article/1958/header/desktop/explorer_1_desktop.webp";

import vanguard1_mobile from "~/assets/images/article/1958/header/mobile/vanguard1_mobile.webp";
import vanguard1_tablet from "~/assets/images/article/1958/header/tablet/vanguard1_tablet.webp";
import vanguard1_desktop from "~/assets/images/article/1958/header/desktop/vanguard1_desktop.webp";
</script>
